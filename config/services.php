...
return [
    ...
    */
    ...
    'ses' => [
        ...
        'ruta_caratulas' => 'tramiteslinea/caratulas/',
    ],
    ...
    'sgc' => [
        ...
        'consultar_cuenta_predial_tramite' => env('SGC_CONSULTAR_CUENTA_PREDIAL_TRAMITE'),
        ...
        'responder_requerimiento' => env('SGC_RESPONDER_REQUERIMIENTO'),
