...
class SGCService {
    ...
    public function consultarTramites(int $entidad_id, string | null $estado, int | null $año, int |null $folio, int |null $usuario, string | null $tipo_servicio, string | null $servicio, int |null $localidad, int |null $oficina, int |null $t_predio, int |null $registro, int $pagina_actual, int $pagination):array
    {
