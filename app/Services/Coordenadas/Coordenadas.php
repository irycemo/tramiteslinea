...
class Coordenadas{
    ...
    public function utm2ll($x,$y,$zone,$aboveEquator){
        ...
        return array('success'=>true,'attr'=>array('lat'=>$this->radian2degree($latlon[0]),'lon'=>$this->radian2degree($latlon[1])));
    }

    public function ll2utm($lat,$lon){
        if(!is_numeric($lon)){
            return array('success'=>false,'msg'=>"Valor de longitud incorrecto");
        }
        if($lon<-180.0 or $lon>=180.0){
            return array('success'=>false,'msg'=>"La longitud esta fuera de rango");
        }
        if(!is_numeric($lat)){
            return array('success'=>false,'msg'=>"Valor de latitud incorrecto");
        }
        if($lat<-90.0 or $lat>90.0){
            return array('success'=>false,'msg'=>"La latitud esta fuera de rango");
        }
        ...
        return array('success'=>true,'attr'=>array('x'=>$result[0],'y'=>$result[1],'zone'=>$zone,'aboveEquator'=>$aboveEquator));
    }
