...
class IdentificacionInmueble extends Component
{
    ...
    protected function rules(){
        return [
            ...
            'aviso.nombre_vialidad' => 'required',
            'aviso.numero_exterior' => 'required',
            'aviso.numero_exterior_2' => 'nullable',
            'aviso.numero_interior' => 'nullable',
            'aviso.numero_adicional_2' => 'nullable',
            'aviso.numero_adicional' => 'nullable',
            'aviso.codigo_postal' => 'required|numeric',
            'aviso.lote_fraccionador' => 'nullable',
            'aviso.manzana_fraccionador' => 'nullable',
            'aviso.etapa_fraccionador' => 'nullable',
            'aviso.nombre_predio'  => 'nullable',
            'aviso.nombre_edificio' => 'nullable',
            'aviso.clave_edificio' => 'nullable',
            'aviso.departamento_edificio' => 'nullable',
    ...
    public function cargarAvaluo(){
        ...
        try {
            ...
            if($response->status() === 200){
                ...
                $this->aviso->superficie_terreno = (float)$data['data']['superficie_terreno'] + collect($data['data']['terrenos_comun'])->sum('superficie_proporcional');
                $this->aviso->superficie_construccion = (float)$data['data']['superficie_construccion'] + collect($data['data']['construcciones_comun'])->sum('superficie_proporcional');
