...
class MisTramites extends Component
{
    ...
    public function validarPago($tramite){
        ...
        try {
            ...
            (new STramtiesService())->acreditarPago($tramite['linea_de_captura']);
    ...
    public function mount(){
        ...
        if(auth()->user()->hasRole('Administrador')){
            ...
            abort(403, 'Esta área no esta disponible para usuarios con rol Administrador para ver los tramites dirigase al Sistema RPP.');
        ...
        try {
            ...
            $servicios = (new STramtiesService())->consultarServicios(['DC94',
                                                                        'DC95',
                                                                        'DC97',
                                                                        'DC96',
                                                                        'DL21',
    ...
    public function render()
    {
        ...
        try {
            ...
            $data = (new STramtiesService())->consultarTramites(
        ...
        return view('livewire.rpp.tramites.mis-tramites', compact('tramites'))->extends('layouts.admin');
