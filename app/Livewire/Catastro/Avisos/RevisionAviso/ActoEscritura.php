...
class ActoEscritura extends Component
{
    ...
    protected function rules(){
        return [
            ...
            'aviso.numero_escritura' => Rule::requiredIf($this->aviso->tipo_escritura != 'SIN DOCUMENTO'),
            'aviso.volumen_escritura' => Rule::requiredIf($this->aviso->tipo_escritura != 'SIN DOCUMENTO'),
