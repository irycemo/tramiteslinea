...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('avisos', function (Blueprint $table) {
            ...
            $table->decimal('superficie_terreno', 10,4)->nullable();
            $table->decimal('superficie_construccion', 10,4)->nullable();
            $table->string('cantidad_tramitada')->nullable();
            $table->text('descripcion_fideicomiso')->nullable();
            $table->text('observaciones')->nullable();
            $table->decimal('valor_adquisicion', 10,4)->nullable();
            $table->decimal('valor_catastral', 10,4)->nullable();
            $table->string('uso_de_predio')->nullable();
            $table->date('fecha_reduccion')->nullable();
            $table->decimal('valor_construccion_vivienda', 10,4)->nullable();
            $table->decimal('valor_construccion_otro', 10,4)->nullable();
            $table->decimal('porcentaje_adquisicion', 10,4)->nullable();
            $table->decimal('reduccion', 10,4)->nullable();
            $table->decimal('base_gravable', 10,4)->nullable();
            $table->boolean('sin_reduccion')->default(0);
            $table->boolean('no_genera_isai')->default(0);
            $table->decimal('valor_base', 10,4)->nullable();
            $table->decimal('valor_isai', 10,4)->nullable();
