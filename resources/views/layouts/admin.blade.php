    ...
    <div class="relative max-h-screen md:flex">
        ...
        <div id="sidebar" class="z-10 bg-white w-64 absolute inset-y-0 left-0 transform -translate-x-full transition duration-200 ease-in-out md:relative md:translate-x-0">
            ...
            <nav class="p-4 text-rojo overflow-y-auto h-menu">
                ...
                @can('Usuarios notaria')

                    <a href="{{ route('usuarios_notaria') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex items-center hover  hover:bg-gray-100 p-2 px-4 rounded-xl focus:outline-rojo focus:outline-offset-2 w-full">
