    ...
    <div class="mb-2 lg:mb-5">
        ...
        <div class="flex justify-between gap-3 overflow-auto p-1">
            ...
            <div class="flex gap-3 overflow-auto p-1">
                ...
                <input type="number" wire:model.live.debounce.500mse="filters.folio" placeholder="Folio" class="bg-white rounded-full text-sm w-min">

                <input type="number" wire:model.live.debounce.500mse="filters.usuario" placeholder="Usuario" class="bg-white rounded-full text-sm w-min">
            ...
            <div class="">
                ...
                <a href="{{ route('revision') }}" class="whitespace-nowrap bg-gray-500 hover:shadow-lg hover:bg-gray-700 text-sm py-2 px-4 text-white rounded-full hidden md:block items-center justify-center focus:outline-gray-400 focus:outline-offset-2">
                        ...
                        <x-table.cell title="Acciones">
                            ...
                            <div class="ml-3 relative" x-data="{ open_drop_down:false }">
                                ...
                                <div x-cloak x-show="open_drop_down" x-on:click="open_drop_down=false" x-on:click.away="open_drop_down=false" class="z-50 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                                    ...
                                    @if(in_array($aviso->estado, ['nuevo']))
