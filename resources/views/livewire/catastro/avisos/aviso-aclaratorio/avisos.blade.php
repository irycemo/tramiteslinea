    ...
    <div class="mb-2 lg:mb-5">
        ...
        <div class="flex justify-between gap-3 overflow-auto p-1">
            ...
            <div class="">
                ...
                <a href="{{ route('aviso') }}" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 text-sm py-2 px-4 text-white rounded-full hidden md:block items-center justify-center focus:outline-gray-400 focus:outline-offset-2">
