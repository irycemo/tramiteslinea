        ...
        <x-slot name="content">
            ...
            @if($tramiteSeleccionado)
                ...
                <div class="flex justify-center mt-3">
                    <span class="col-span-1 lg:col-span-2">Inmueble</span>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                    ...
                    <div class="rounded-lg bg-gray-100 py-1 px-2">
                        ...
                        <p><strong>Folio real:</strong> {{ $tramiteSeleccionado['folio_real'] }}</p>

                    </div>

                    <div class="rounded-lg bg-gray-100 py-1 px-2">

                        <p><strong>Tomo:</strong> {{ $tramiteSeleccionado['tomo'] }}</p>

                    </div>

                    <div class="rounded-lg bg-gray-100 py-1 px-2">

                        <p><strong>Registro:</strong> {{ $tramiteSeleccionado['registro'] }}</p>

                    </div>

                    <div class="rounded-lg bg-gray-100 py-1 px-2">

                        <p><strong>Distrito:</strong> {{ $tramiteSeleccionado['distrito'] }}</p>

                    </div>

                    <div class="rounded-lg bg-gray-100 py-1 px-2">

                        <p><strong>Número de propiedad:</strong> {{ $tramiteSeleccionado['numero_propiedad'] }}</p>
