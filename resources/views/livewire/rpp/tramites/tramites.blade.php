        ...
        <x-slot name="content">
            ...
            @if($tramiteSeleccionado)
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                    ...
                    @if (isset($tramiteSeleccionado['numero_oficio']))
                    ...
                    @if (isset($tramiteSeleccionado['cantidad']))
                    ...
                    @if (isset($tramiteSeleccionado['fecha_vencimiento']))
                    ...
                    @if (isset($tramiteSeleccionado['folio_pago']))
