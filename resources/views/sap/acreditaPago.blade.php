<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        @if($status === 'success')
            ...
            <div class="flex p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 w-full lg:w-1/2 text-center mx-auto shadow-lg" role="alert">
